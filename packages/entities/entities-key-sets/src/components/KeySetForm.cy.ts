...
describe('<KeySetForm />', () => {
  describe('Kong Manager', () => {
    ...
    it('should show create form', () => {
      ...
      // button state
      cy.getTestId('set-create-form-cancel').should('be.visible')
      cy.getTestId('set-create-form-submit').should('be.visible')
      cy.getTestId('set-create-form-cancel').should('be.enabled')
      cy.getTestId('set-create-form-submit').should('be.disabled')
      // form fields
    ...
    it('should correctly handle button state - create', () => {
      ...
      cy.getTestId('set-create-form-submit').should('be.enabled')
