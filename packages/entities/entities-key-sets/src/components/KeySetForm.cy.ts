...
describe('<KeySetForm />', () => {
  describe('Kong Manager', () => {
    ...
    it('should show create form', () => {
      ...
      // button state
      cy.getTestId('key_set-form-cancel').should('be.visible')
      cy.getTestId('key_set-form-submit').should('be.visible')
      cy.getTestId('key_set-form-cancel').should('be.enabled')
      cy.getTestId('key_set-form-submit').should('be.disabled')
      // form fields
    ...
    it('should correctly handle button state - create', () => {
      ...
      cy.getTestId('key_set-form-submit').should('be.enabled')
    ...
    it('should handle error state - failed to load Key Set', () => {
      ...
      cy.getTestId('key_set-form-cancel').should('not.exist')
      cy.getTestId('key_set-form-submit').should('not.exist')
