...
export type PluginFeatured = 'Featured'

export const PluginFeaturedGroupKey: PluginFeatured = 'Featured'

export const PluginFeaturedArray: PluginFeatured[] = [PluginFeaturedGroupKey]
