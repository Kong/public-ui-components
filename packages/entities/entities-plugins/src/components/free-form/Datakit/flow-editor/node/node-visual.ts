import { KUI_COLOR_BACKGROUND_DECORATIVE_AQUA_WEAKEST, KUI_COLOR_BACKGROUND_DECORATIVE_PURPLE_WEAKEST, KUI_COLOR_BACKGROUND_WARNING_WEAKEST, KUI_COLOR_TEXT_DANGER, KUI_COLOR_TEXT_DANGER_WEAKEST, KUI_COLOR_TEXT_DECORATIVE_AQUA, KUI_COLOR_TEXT_DECORATIVE_PINK, KUI_COLOR_TEXT_DECORATIVE_PURPLE, KUI_COLOR_TEXT_NEUTRAL_STRONGEST, KUI_COLOR_TEXT_PRIMARY, KUI_COLOR_TEXT_PRIMARY_WEAKEST, KUI_COLOR_TEXT_SUCCESS, KUI_COLOR_TEXT_SUCCESS_WEAKEST, KUI_COLOR_TEXT_WARNING } from '@kong/design-tokens'
import {
  ArrowSplitIcon,
  CodeblockIcon,
  GatewayIcon,
