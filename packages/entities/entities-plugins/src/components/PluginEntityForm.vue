  ...
  <div class="kong-ui-entities-plugin-form">
    ...
    >
      ...
      >
        ...
        <template
          v-if="PLUGIN_METADATA[formModel.name].fieldChecks"
          #plugin-config-before-content
        >
          <PluginFieldCheckAlerts :field-checks="PLUGIN_METADATA[formModel.name].fieldChecks!" />
        </template>
      </VueFormGenerator>
    </div>
  </div>
...
import PluginFieldCheckAlerts from './PluginFieldCheckAlerts.vue'
