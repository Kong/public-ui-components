...
describe('<VaultForm />', () => {
  describe('Kong Manager', () => {
    ...
    it('should show create form', () => {
      ...
      cy.get('[data-testid="k-select-item-kubernetes"] button').click()
    ...
    it('should correctly handle button state - create', () => {
      ...
      cy.get('.k-select-item:eq(0) button').click()
      cy.getTestId('form-submit').should('be.enabled')
      ...
      cy.get('[data-testid="k-select-item-http"] button').click()
      ...
      cy.get('[data-testid="k-select-item-v1"] button').click()
