...
describe('<UpstreamsFormLoadBalancing/>', () => {
  ...
  it('Should bind algorithm data correctly', () => {
    ...
    cy.get('.algorithm-select .select-list .select-item').should('have.length', 4)
    cy.get('.algorithm-select .select-list [data-testid="select-item-least-connections"]').click()
  ...
  it('Should bind hashOn data correctly', () => {
    ...
    cy.get('.hash-on-select .select-list [data-testid="select-item-header"]').click()
  ...
  it('Should bind hashFallback data correctly', () => {
    ...
    cy.get('.hash-fallback-select .select-list [data-testid="select-item-header"]').click()
