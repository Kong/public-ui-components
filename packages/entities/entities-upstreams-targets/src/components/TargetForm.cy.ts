...
describe('<TargetForm />', { viewportHeight: 700, viewportWidth: 700 }, () => {
  describe('Kong Manager', () => {
    ...
    it('should show create form', () => {
      ...
      // button state
      cy.get('button[data-testid="modal-cancel-button"]').should('be.visible')
      cy.get('button[data-testid="modal-action-button"]').should('be.visible')
      cy.get('button[data-testid="modal-cancel-button"]').should('be.enabled')
    ...
    it('should correctly handle button state - create', () => {
      ...
      cy.get('button[data-testid="modal-action-button"]').should('be.enabled')
