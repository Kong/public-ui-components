...
describe('<UpstreamsFormGeneralInfo />', () => {
  describe('Konnect', () => {
    ...
    it('bind Name data correctly', () => {
      ...
      cy.get('.name-select .select-list').should('be.visible')
      cy.get('.name-select .select-list .select-item').should('have.length', 5)
    ...
    it('should allow Name creation', () => {
      ...
      cy.get('.name-select .select-list .select-add-item').should('have.length', 1)
      cy.get('.name-select .select-list .select-add-item').click()
    ...
    it('should accept and display created Name', () => {
      ...
      cy.get('.name-select').click()
      cy.get('.name-select .select-list').should('be.visible')
      cy.get('.name-select .select-list .select-item').last().should('contain.text', createdName)
    })
    ...
    it('bind clientCertificate data correctly', () => {
      ...
      cy.get('.certificate-select .select-list').should('be.visible')
      cy.get('.certificate-select .select-list .select-item').should('have.length', 5)
      cy.get('.certificate-select .select-list [data-testid="select-item-2"]').click()
