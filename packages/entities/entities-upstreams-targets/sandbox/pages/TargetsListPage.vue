...
const patPermissions = {
  create: { service: AppType.Konnect, action: '#create', resourcePath: `runtimegroups/${controlPlaneId}/upstreams/${upstreamId}/targets/*` },
  delete: { service: AppType.Konnect, action: '#delete', resourcePath: `runtimegroups/${controlPlaneId}/upstreams/${upstreamId}/targets/*` },
  edit: { service: AppType.Konnect, action: '#edit', resourcePath: `runtimegroups/${controlPlaneId}/upstreams/${upstreamId}/targets/*` },
}
