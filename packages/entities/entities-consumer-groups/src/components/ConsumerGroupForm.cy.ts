...
describe('<ConsumerGroupForm />', () => {
  describe('Konnect', () => {
    ...
    it('Create form should be rendered correctly', () => {
      ...
      cy.getTestId('consumer_group-form-cancel').should('be.visible')
      cy.getTestId('consumer_group-form-cancel').should('be.enabled')
      cy.getTestId('consumer_group-form-submit').should('be.visible')
      cy.getTestId('consumer_group-form-submit').should('be.disabled')
    })
    ...
    it('Submit button should be enabled if name field is filled in correctly', () => {
      ...
      cy.getTestId('consumer_group-form-submit').should('be.enabled')
    })
