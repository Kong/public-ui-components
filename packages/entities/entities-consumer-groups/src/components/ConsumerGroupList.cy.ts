  ...
  describe('Konnect', () => {
    ...
    const interceptKonnect = (params?: {
      ...
      cy.intercept(
        {
          method: 'GET',
          url: `${baseConfigKonnect.apiBaseUrl}/api/control_planes/${baseConfigKonnect.controlPlaneId}/consumer_groups*`,
        },
        {
          statusCode: 200,
          body: {
    ...
    const interceptConsumerKonnect = (params?: {
      ...
      cy.intercept(
        {
          method: 'GET',
          url: `${configConsumerKonnect.apiBaseUrl}/api/control_planes/${configConsumerKonnect.controlPlaneId}/consumers/${configConsumerKonnect.consumerId}/consumer_groups*`,
        },
        {
          statusCode: 200,
          body: {
