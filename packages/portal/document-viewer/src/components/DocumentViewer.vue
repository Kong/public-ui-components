...
.document-viewer {
  ...
  font-family: var(--kong-ui-document-viewer-font-family-default, var(--kui-font-family-text, $kui-font-family-text));
  font-size: var(--kong-ui-document-viewer-font-size, var(--kui-font-size-40, $kui-font-size-40));
}
</style>
