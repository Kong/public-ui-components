...
<style lang="scss">
:root {
  --document-viewer-font-family-default: #{$kui-font-family-text};
  --document-viewer-font-family-monospace: #{$kui-font-family-code};
}
</style>
<style lang="scss" scoped>
.document-viewer {
  color: var(--document-viewer-color, $kui-color-text);
  font-family: var(--document-viewer-font-family-default, $kui-font-family-text);
  font-size: var(--document-viewer-font-size, $kui-font-size-40);
}
</style>
