<template>
  ...
  >
    <ZoomActions
      v-if="state.state === 'zoom-interactive' && zoomTimeRange && zoomOptions"
...
import ZoomActions, { type ZoomOptions } from '../ZoomActions.vue'
...
const context = computed(() => {
  return formatTime(props.state.tooltipContext)
})
