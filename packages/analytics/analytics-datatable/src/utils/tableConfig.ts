...
export const getSortKey = (config: Pick<AnalyticsDatatableConfig, 'sortColumnKey' | 'sortColumnOrder'>): string => {
...
export const hasConfiguredColumnWidths = (config: AnalyticsDatatableConfig): boolean => (
...
const resolveSort = <Row extends Record<string, any>>(
  config: AnalyticsDatatableConfig,
  headersOrKeys: Array<AnalyticsDatatableHeader<Row>> | Set<string>,
): Pick<AnalyticsDatatableConfig, 'sortColumnKey' | 'sortColumnOrder'> => {
