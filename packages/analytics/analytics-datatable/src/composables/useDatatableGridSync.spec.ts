...
describe('useDatatableGridSync', () => {
  ...
  const defaultResolvedConfig: AnalyticsDatatableConfig = {
  ...
  const mountGridSync = ({
    ...
    rowSelection = ref<AnalyticsDatatableRowSelectionMode>('none'),
    ...
    resolvedTableConfig?: AnalyticsDatatableConfig
    rowSelection?: Ref<AnalyticsDatatableRowSelectionMode>
