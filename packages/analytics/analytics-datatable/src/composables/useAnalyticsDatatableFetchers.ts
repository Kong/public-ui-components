...
type RefreshOptions = {
  pageSize?: number
  sortColumnKey?: AnalyticsDatatableConfig['sortColumnKey']
  sortColumnOrder?: AnalyticsDatatableConfig['sortColumnOrder']
}
...
type FetcherParamSources = {
  ...
  sortColumnKey: Readonly<Ref<AnalyticsDatatableFetcherParams['sortColumnKey']>>
  sortColumnOrder: Readonly<Ref<AnalyticsDatatableFetcherParams['sortColumnOrder']>>
...
export const useAnalyticsDatatableFetchers = <Row extends Record<string, any>>({
  ...
  const resolveHasNextPageWhenTotalUnknown = ({
    ...
    page: number
    pageSize: number
    result: AnalyticsDatatableFetcherResult<Row>
