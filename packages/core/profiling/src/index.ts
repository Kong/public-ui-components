...
import FlameChart from './components/flame-chart/FlameChart.vue'
import FlameNodeList from './components/flame-chart/FlameNodeList.vue'
import FlameNodeListRow from './components/flame-chart/FlameNodeListRow.vue'
...
//     app.component(options.name || 'Profiling', Profiling)
//   },
// }

export { FlameChart, FlameNodeList, FlameNodeListRow }
