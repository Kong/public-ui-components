...
const packageName = 'kong-ui-publictest-lerna-publish-2'
...
// If we are trying to preview a build of the local `package/kong-ui-publictest-lerna-publish-2/sandbox` directory,
