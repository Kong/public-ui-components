...
- `TreeMapChart`: hierarchical part-to-whole rectangles with a categorical token palette and drill-down
...
- [TreeMapChart](./docs/treemap-chart.md): what it does and how to use it
