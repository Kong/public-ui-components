...
describe('<VerticalNavigation />', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render the toggle left panel button when paneLeftVisible is true', () => {
      ...
      const toggleButton = wrapper.getTestId('kong-ui-public-split-pane-toggle-left-panel-button')
  ...
  describe('active state', () => {
    it('should apply active class to active navigation items', () => {
      ...
      const wrapper = createWrapper({ items })
      const activeItem = wrapper.getTestId('kong-ui-public-split-pane-vertical-navigation-nav-item-active-item')
    ...
    it('should not apply active class to inactive navigation items', () => {
      ...
      const returnButton = wrapper.getTestId('kong-ui-public-split-pane-vertical-navigation-nav-item-inactive-item')
  ...
  describe('navigation item clicks', () => {
    it('should prevent navigation when clicking an already active item', async () => {
      ...
      const wrapper = createWrapper({ items })
      const button = wrapper.getTestId('kong-ui-public-split-pane-vertical-navigation-nav-item-active-item')
  ...
  describe('accessibility', () => {
    it('should set correct aria-label on navigation buttons', () => {
      ...
      const wrapper = createWrapper({ items })
      const button = wrapper.getTestId('kong-ui-public-split-pane-vertical-navigation-nav-item-test-item')
